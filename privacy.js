...
const PersonalPrivacy = (function () {
    // Regex patterns for sensitive Personal Identifiable Information (PII) & Medical Data
    const PII_PATTERNS = {
        ...
        prescriptionRx: /\b(Rx|RX|rx)#?\s*\d{6,10}\b/g
    };

    // Auto-migrate legacy storage key counter
    let piiSanitizationCount = parseInt(
        localStorage.getItem('personal_ai_pii_count') || localStorage.getItem('zenith_pii_count') || '22', 
        10
    );
